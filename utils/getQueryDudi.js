export function getQuery (query,page,id_tahun) {
    ...
    d.id,d.nama_instansi_perusahaan,d.no_telepon,d.deskripsi,d.bidang,ad.detail_tempat,ad.desa,ad.kecamatan,ad.kabupaten,ad.provinsi,ad.negara,ks.total as total_kouta,ks.jumlah_wanita as kouta_perempuan,ks.jumlah_pria as kouta_laki
    FROM dudi as d
